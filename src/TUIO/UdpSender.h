...
public:
  /**
   * This constructor creates a UdpSender that sends to the provided port on the
   * the given host using the default MTU size of 1500 bytes to deliver
   * unfragmented UDP packets on a LAN
   *
